...
determinacy7=[0.36,0.9370,0.9904]
...
plt.plot(samplesizeg7,determinacy7,marker = 'x', label='Determinacy')
plt.xlabel('Dataset Size')
plt.legend()
plt.show()
...
determinacyg8=[0.9904,0.9902,0.9898,0.9928]
...
plt.plot(utilityg8,determinacyg8,marker='x',label='Determinacy')
plt.xlabel('u')
plt.legend()
plt.show()
...
determinacyg9=[0.9370,0.8804,0.7913]
